...
import { ContactBackground,MenuItemStyle,TextStyle,ContactContainer} from '../../styles/viewsStyle/ContactStyle';
...
const Contact = () => {
    return (
        <Container id="contact" style={ContactBackground}>
		  ...
		  <Row style={ContactContainer}> <ButtonRey data={{label:"Say Hello",onClick:openEmail}}></ButtonRey> </Row>        
          <> <Footer></Footer> </>      
       </Container>
    )
}
